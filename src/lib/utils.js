...
export const getValor125 = (movimiento) => {
  if (movimiento?.tipo_movimiento !== 'factura_venta') return 0;
  return Math.round(getBaseAntesIva(movimiento) * 0.0125);
};

export const isIngreso = (tipo) => ['ingreso', 'factura_venta'].includes(tipo);

export const isEgreso = (tipo) => ['egreso', 'gasto', 'compra', 'pago'].includes(tipo);
